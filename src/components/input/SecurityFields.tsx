    ...
    return (
      <React.Fragment>
        <div>
          <label
            className={
              errors[`authorized_cidrs`] && checkError
                ? "mb0 error-text"
                : "mb0"
            }
          >
          ...
          <input
            ...
            className={
              errors[`authorized_cidrs`] && checkError ? "mb4 error" : "mb4"
            }
          />
        </div>
        {isApiAdmin && (
          <div>
            <label
              className={
                errors[`authorized_recipients`] && checkError
                  ? "mb0 error-text"
                  : "mb0"
              }
            >
        ...
        {isApiAdmin && (
          <div>
            <label
              className={
                errors[`max_allowed_payment_amount`] && checkError
                  ? "mb0 error-text"
                  : "mb0"
              }
            >
